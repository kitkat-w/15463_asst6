...
objName = 'scene7/' #object name (should correspond to a dir in data)
seqName = 'v1' #sequence name (subdirectory of object)
calName = 'my_calib' #calibration sourse (also a dir in data)
...
dX = 220.0 #calibration plane length in x direction
dY = 160.0  #calibration plane length in y direction
...
firstFrame = os.path.join(baseDir, objName, '0001.jpg')
